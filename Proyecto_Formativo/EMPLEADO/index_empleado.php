...
<body>
    ...
    <script src="main_empleado.js"></script>
    <script src="modal_empleado.js"></script>
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            .then(data => {
                if (!data.error) {
                    ...
                    if (data.foto_perfil) {
                        document.getElementById("imgPerfilNav").src = data.foto_perfil;
                    } else {
                        document.getElementById("imgPerfilNav").src = "https://cdn-icons-png.flaticon.com/512/2922/2922510.png";
                    }
