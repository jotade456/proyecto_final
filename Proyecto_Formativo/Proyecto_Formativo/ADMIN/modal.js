...
document.querySelector('.formulario-producto button').addEventListener('click', function (e) {
  e.preventDefault();
  mostrarVentana();
  limpiarFormularioProducto();
});
...
document.querySelector('.formulario-producto-mod button').addEventListener('click', function (e) {
  e.preventDefault();
