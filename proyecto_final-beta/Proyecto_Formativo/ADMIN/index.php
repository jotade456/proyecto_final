    ...
    <div class="modal-producto" id="modalProducto">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="../controlador/controlador.php" class="formulario-producto" enctype="multipart/form-data">
    ...
    <div class="modal-producto-mod" id="modalProductoModificar">
        <div class="modal-content-mod">
            ...
            <div class="modal-body-mod">
                ...
                <form class="formulario-producto-mod" method="POST" action="../controlador/controlador.php">
    ...
    <div class="modal-producto-eli" id="modalProductoEliminar">
        <div class="modal-content-eli">
            ...
            <div class="modal-body-eli" id="modaleliminar">
                ...
                <form class="formulario-producto-eli" method="POST" action="../controlador/controlador.php">
        ...
        <div class="modal-content-cuentas">
            ...
            <div class="modal-body-cuentas">
                <div class="usuarios-contenedor" id="usuariosContenedor">
                    <!-- Aquí el JS insertará las tarjetas de los usuarios -->
                </div>
